/**
 * @file main.c
 * @brief This program demonstrates how to scan for available Wi-Fi networks
 *        using the ESP32 and FreeRTOS. It continuously scans for networks,
 *        retrieves their details (SSID, RSSI, Channel, MAC address), and
 ...
 * 
 * @usage
 * 1. Initialize NVS, Wi-Fi, and networking interfaces.
 * 2. Configure and start Wi-Fi in Station mode.
 * 3. Continuously scan for Wi-Fi networks and display their information.
 * 
 * @functions
 * - scann(): Scans for available Wi-Fi networks and prints their details.
 * - app_main(): Main function where Wi-Fi scanning is initialized and run.
 */
